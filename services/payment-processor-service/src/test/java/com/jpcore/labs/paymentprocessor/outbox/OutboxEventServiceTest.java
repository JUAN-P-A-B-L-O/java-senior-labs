...
class OutboxEventServiceTest {
    ...
    void savesPaymentProcessedEventAsWaitingPublish() {
        ...
        OutboxEventEntity result = service.savePaymentProcessed(REQUESTED_EVENT_ID, PAYMENT_ID);
    ...
    void savesPaymentProcessingFailedEventAsWaitingPublish() {
        ...
        OutboxEventEntity result = service.savePaymentProcessingFailed(REQUESTED_EVENT_ID, PAYMENT_ID, "denied");
